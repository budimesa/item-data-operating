          ...
          <div class="bg-white p-6 rounded-lg shadow-lg w-full max-w-md" @click.stop>
            ...
            <form @submit.prevent="update">
              ...
              <div class="mb-4">
                ...
                <textarea id="density_code" v-model="currentDensity.density_code" rows="4" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"></textarea>
              </div>
          ...
          <div class="bg-white p-6 rounded-lg shadow-lg w-full max-w-md" @click.stop>
            ...
            <form @submit.prevent="create">
              ...
              <div class="mb-4">
                ...
                <textarea id="new_density_code" v-model="newDensity.density_code" rows="4" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"></textarea>
              </div>
              <div class="flex justify-end space-x-2">
