          ...
          <div class="bg-white p-6 rounded-lg shadow-lg w-full max-w-md" @click.stop>
            ...
            <form @submit.prevent="update">
              ...
              <div class="mb-4">
                ...
                <input type="text" id="color_code" v-model="currentColor.color_code" rows="4" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"></input type="text">
              </div>
          ...
          <div class="bg-white p-6 rounded-lg shadow-lg w-full max-w-md" @click.stop>
            ...
            <form @submit.prevent="create">
              ...
              <div class="mb-4">
                ...
                <input type="text" id="new_color_code" v-model="newColor.color_code" rows="4" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"></input type="text">
              </div>
              <div class="flex justify-end space-x-2">
